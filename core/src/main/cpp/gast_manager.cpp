...
namespace gast {
    ...
    String GastManager::acquire_and_bind_mesh_instance(const godot::String &parent_node_path) {
    ...
    void GastManager::unbind_and_release_mesh_instance(const godot::String &node_path) {
