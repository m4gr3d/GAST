...
JNI_METHOD(bindMeshInstance)(JNIEnv *env, jobject, jstring parent_node_path) {
    return string_to_jstring(env, GastManager::get_singleton_instance()->bind_mesh_instance(
