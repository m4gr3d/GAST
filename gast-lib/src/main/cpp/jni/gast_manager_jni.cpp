...
JNIEXPORT void JNICALL JNI_METHOD(setupMeshInstance)(JNIEnv *env, jobject, jstring node_path) {
    GastManager::get_singleton_instance()->setup_mesh_instance(
            jstring_to_string(env, node_path));
}

JNIEXPORT jstring JNICALL
JNI_METHOD(createMeshInstance)(JNIEnv *env, jobject, jstring parent_node_path) {
